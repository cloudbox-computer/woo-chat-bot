...
function buildSystemPrompt(tenant: Tenant, policy: TenantPolicy): string {
  ...
  return [
    ...
    "- When using knowledge or website content, cite the supplied source title or store page naturally at the end of the relevant statement; never invent a source.",
